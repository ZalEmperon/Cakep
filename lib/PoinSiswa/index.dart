                      ...
                      children: [
                        TableCell(
                          child: Padding(
                            padding: EdgeInsets.all(19),
                            child:
                                Text("3103119092", textAlign: TextAlign.center),
                          ),
                        ),
                      ],
                    ),
                      ...
                      children: [
                        TableCell(
                          child: Padding(
                            padding: EdgeInsets.all(19),
                            child:
                                Text("XII RPL 3", textAlign: TextAlign.center),
                          ),
                        ),
                      ],
                    )
            ...
            new MaterialButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => add_poin()));
              },
              child: Text("Add"),
              color: Colors.red,
                ...
                child: Table(
                  ...
                  children: [
                    ...
                    TableRow(children: [
                      ...
                      Column(children: [
                        Text(
                            'Jika ada perselisihan, saya akan menyelesaikan dengan musyawarah')
                      ]),
                    ...
                    TableRow(children: [
                      ...
                      Column(children: [
                        Text('Saya Belajar dari peristiwa yang terjadi')
                      ]),
                      Column(children: [Text('10')]),
